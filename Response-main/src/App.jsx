                ...
                <div className="schematic-slider" style={{ transform: `translateX(-${currentSchematicIdx * 100}%)` }}>
                  {schematicImages.map((item) => (
                    <div key={item.id} className="schematic-slide">
                      <img src={getImgUrl(item.img)} alt={item.title} className="schematic-img" />
                ...
                <div className="news-slider" style={{ transform: `translateX(-${currentNewsIdx * 100}%)` }}>
                  {newsImages.map((item) => (
                    <div key={item.id} className="news-slide">
                      <img src={getImgUrl(item.img)} alt={item.title} className="news-image" />
                    </div>
                  ))}
                </div>
            ...
            <section className="now-book-section">
              ...
              <div className="book-display">
                <div className="book-cover-container" key={currentBookIdx}>
                  <img src={getImgUrl(books[currentBookIdx].img)} alt={`${books[currentBookIdx].title} 책 표지`} className="book-cover-img fade-in" />
                  ...
                  {[0, 1, 2].map((offset) => {
                    ...
                    return (
                      <div key={`${book.title}-${offset}`} className="rec-card fade-in">
                        <img src={getImgUrl(book.img)} alt={book.title} className="rec-img" />
                  ...
                  {MOCK_RESULTS.map((item) => (
                    <div key={item.id} className="result-item-card">
                      <div className="item-thumbnail">
                        {item.type === 'book' ? (
                          <img src={getImgUrl(`/book_rec${item.id}.png`)} alt={item.title} onError={(e) => e.target.src = getImgUrl('/book_cover.png')} />
                        ) : (
        ...
        <div className="lecture-overlay">
          <div className="lecture-detail-content">
            ...
            <div className="detail-banner">
              <img src={getImgUrl("/lecture_banner.png")} alt="강좌 배너" />
